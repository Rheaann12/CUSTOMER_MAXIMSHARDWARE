...
export default function Product_Cement() {
  ...
  const cementProducts = [
    { id: 1, title: "Cemex Rizal Portland", brand: "Cement", price: "P 350", img: "https://tse2.mm.bing.net/th/id/OIP.A2Uu-Xf6L_oPIYqD1fRUSQAAAA?pid=Api&P=0&h=220" },
    { id: 2, title: "Big Boss", brand: "Cement", price: "P 350", img: "https://tse3.mm.bing.net/th/id/OIP.IOxL5K2Mbw4R9ErSounyQQAAAA?pid=Api&P=0&h=220" },
    { id: 3, title: "Republic", brand: "Cement", price: "P 350", img: "https://www.primahomedepot.com/images/thumbs/2c6ce483-a6a5-49df-aa50-28d09206361d_republic-cement-type-1p.png" },
    { id: 4, title: "Chichibu White", brand: "Cement", price: "P 350", img: "https://tse3.mm.bing.net/th/id/OIP.0VIvLajz7e5W61tr9Lo3agHaHa?pid=Api&P=0&h=220" },
    { id: 5, title: "Taiheiyo Premium", brand: "Cement", price: "P 350", img: "https://tse4.mm.bing.net/th/id/OIP.F2KoSs5BnTm9rf5e1iAZXgAAAA?pid=Api&P=0&h=220" },
    { id: 6, title: "Cemex Island", brand: "Cement", price: "P 350", img: "https://tse2.mm.bing.net/th/id/OIP.wmG-iS1Bnm3E5_1t_u9MSAAAAA?pid=Api&P=0&h=220 " },
    { id: 7, title: "Cemex APO", brand: "Cement", price: "P 350", img: "https://tse2.mm.bing.net/th/id/OIP.WYE9nVP4p69Fk1RRBG3lQAHaHa?pid=Api&P=0&h=220" },
  ];

  // Filtering Logic
  const filteredProducts = cementProducts.filter(p =>
      ...
      >
        <div className="max-w-[1300px] mx-auto px-4 md:px-10 pt-8 md:pt-10 pb-16 flex flex-col items-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center w-full mb-6 gap-4 md:gap-6">
            <h1 className="text-[24px] md:text-[32px] text-[#2c2c2c] font-normal tracking-tight">Cement Category</h1>
                ...
                currentItems.map((p) => (
                  ...
                  >
                    <div className="flex-1 w-full flex items-center justify-center mb-3 md:mb-4 overflow-hidden min-h-[100px] md:min-h-[160px]">
                      <img src={p.img} alt={p.title} className="max-w-full max-h-full object-contain mix-blend-multiply transition-transform group-hover:scale-110" />
                    </div>

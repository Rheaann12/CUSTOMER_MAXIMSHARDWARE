...
export default function Product_Electrical() {
  ...
  const electricalProducts = [
    { id: 1, title: "Wire THHN 12/2", brand: "Electrical", price: "P 2,850", img: "https://image.made-in-china.com/2f0j00TricoWYMbNbk/Thhn-Thwn-Stranded-Copper-8-10-12-14-AWG-12-2-Electrical-Thhn-Thwn-Wire-Cable-Building-Wire-Electric-Wire-and-Cable.jpg" },
    { id: 2, title: "Wire THHN 14/2", brand: "Electrical", price: "P 1,950", img: "https://www.centralwires.com/wp-content/uploads/2025/01/4-0-thhn-wire.webp" },
    { id: 3, title: "LED Bulb 9W", brand: "Electrical", price: "P 125", img: "https://active-techs.com/wp-content/uploads/2023/04/9w-led-lamp.webp" },
    { id: 4, title: "Circuit Breaker 20A", brand: "Electrical", price: "P 450", img: "https://www.kroger.com/product/images/large/front/0004756907099" },
    { id: 5, title: "Electrical Tape", brand: "Electrical", price: "P 35", img: "https://m.media-amazon.com/images/I/61K7x1fO78L.jpg" },
    { id: 6, title: "Switch 1-Gang", brand: "Electrical", price: "P 85", img: "https://image.made-in-china.com/2f0j00PgRqptfBThbY/1-Gang-2-Way-Switch-Plastic-Material-Electric-Gang-Switch.jpg" },
  ];

  // Filtering Logic
  const filteredProducts = electricalProducts.filter(p =>
      ...
      >
        <div className="max-w-[1300px] mx-auto px-4 md:px-10 pt-8 md:pt-10 pb-16 flex flex-col items-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center w-full mb-6 gap-4 md:gap-6">
            <h1 className="text-[24px] md:text-[32px] text-[#2c2c2c] font-normal tracking-tight">Electrical Category</h1>

...
export default function Product_Nails() {
  ...
  const nailProducts = [
    { id: 1, title: "Common Nail 1\"", brand: "Nails", price: "P 85", img: "https://tse4.mm.bing.net/th/id/OIP.QwpvD91mn-zEyjWNZih_UgHaHa?pid=Api&P=0&h=220" },
    { id: 2, title: "Common Nail 2\"", brand: "Nails", price: "P 95", img: "https://tse2.mm.bing.net/th/id/OIP.m7t0AQhIDG-XYER0CO-U_QHaHa?pid=Api&P=0&h=220" },
    { id: 3, title: "Common Nail 3\"", brand: "Nails", price: "P 105", img: "https://tse1.mm.bing.net/th/id/OIP.IG7WZ9z98dtLeLl8U_wGNAHaHa?pid=Api&P=0&h=220" },
    { id: 4, title: "Common Nail 4\"", brand: "Nails", price: "P 115", img: "https://tse1.mm.bing.net/th/id/OIP.fNBhsyCyEzQJFLUo_u336AHaGQ?pid=Api&P=0&h=220" },
    { id: 5, title: "Concrete Nail 1\"", brand: "Nails", price: "P 125", img: "https://tse1.mm.bing.net/th/id/OIP.fNBhsyCyEzQJFLUo_u336AHaGQ?pid=Api&P=0&h=220" },
    { id: 6, title: "Concrete Nail 2\"", brand: "Nails", price: "P 135", img: "https://tse3.mm.bing.net/th/id/OIP.gmoSKdbrXUgS168dYzyNfQHaHa?pid=Api&P=0&h=220" },
    { id: 7, title: "Concrete Nail 3\"", brand: "Nails", price: "P 145", img: "https://tse2.mm.bing.net/th/id/OIP.ReiPOGlWItq3xzfdVFOozwHaHa?pid=Api&P=0&h=220" },
    { id: 8, title: "Concrete Nail 4\"", brand: "Nails", price: "P 155", img: "https://tse1.mm.bing.net/th/id/OIP.Z4eWzbT7P-xVRSiIh6X3tgHaGk?pid=Api&P=0&h=220" },
  ];

  // Filtering Logic
  const filteredProducts = nailProducts.filter(p =>
      ...
      >
        <div className="max-w-[1300px] mx-auto px-4 md:px-10 pt-8 md:pt-10 pb-16 flex flex-col items-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center w-full mb-6 gap-4 md:gap-6">
            <h1 className="text-[24px] md:text-[32px] text-[#2c2c2c] font-normal tracking-tight">Nails Category</h1>

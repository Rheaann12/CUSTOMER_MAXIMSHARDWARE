...
export default function Product_Paint() {
  ...
  const paintProducts = [
    {
      id: 1,
      title: "Davies Megacryl Gray",
      brand: "Paint",
      price: "P 350",
      img: "https://tse2.mm.bing.net/th/id/OIP.ONUvKio0lGCq64jV3rjIdQHaHa?pid=Api&P=0&h=220"
    },
    {
      id: 2,
      title: "Davies Sun & Rain",
      brand: "Paint",
      price: "P 350",
      img: "https://tse3.mm.bing.net/th/id/OIP.RG2q-c3L2D2ZBMo76TubdQHaHa?pid=Api&P=0&h=220s"
    },
    {
      id: 3,
      title: "Davies RoofShield",
      brand: "Paint",
      price: "P 350",
      img: "https://tse2.mm.bing.net/th/id/OIP.87o-VYzY0syodTKJGyW9kgHaHa?pid=Api&P=0&h=220"
    },
    {
      id: 4,
      title: "Davies SR-021",
      brand: "Paint",
      price: "P 350",
      img: "http://hardwarehub.ph/cdn/shop/files/DaviesSR-021Sun_RainTulleWhite.jpg?crop=center&height=1200&v=1744278216&width=1200"
    },
  ];

  // Filtering Logic
  const filteredProducts = paintProducts.filter(p =>
      ...
      >
        <div className="max-w-[1300px] mx-auto px-4 md:px-10 pt-8 md:pt-10 pb-16 flex flex-col items-center relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center w-full mb-6 gap-4 md:gap-6">
            <h1 className="text-[24px] md:text-[32px] text-[#2c2c2c] font-normal tracking-tight">Paint Category</h1>
